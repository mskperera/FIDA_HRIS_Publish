<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="CreateSalarySession.aspx.cs" Inherits="Smarter_HRIS.CreateSalarySession" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <legend>Create Salary Session</legend>
                ...
                <div class="grid">
                    <div class="row">
                        <div class="span3">
                            ...
                            <br />
                            <label>Attendance Session Start<sup class="fg-red">*</sup></label>
                            <label>Attendance Session End<sup class="fg-red">*</sup></label>
                            <label>Note</label>
                        </div>
                        ...
                        <div class="span5">
                          <%--  <asp:Label ID="lblCompanyName" Visible="true" runat="server" Text="" Font-Bold="true" Height="30" Width="600"></asp:Label>--%>
                            ...
                            <br />
                            <asp:Label ID="Label1" Visible="true" runat="server" Text="Attendance Session" Font-Bold="true"></asp:Label><br />
                        ...
                        <div class="span2">
                            ...
                            <label>OT Session Start<sup class="fg-red">*</sup></label>
                            <label>OT Session End<sup class="fg-red">*</sup></label>
                        </div>
                        <div class="span4">
                            <br />
                         <br />
                             <asp:Label ID="Label2" Visible="true" runat="server" Text="OT Session" Font-Bold="true"></asp:Label><br />
                            <input type="date" id="txtOTFromDate" runat="server" name="txtOTFromDate" style="width: 198px;" /><br />
                            <input type="date" id="txtOTToDate" runat="server" name="txtOTToDate" style="width: 198px;" />
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <asp:GridView ID="grdSession" runat="server" DataKeyNames="SessionID,CompanyRegistrationID" Width="100%" AutoGenerateColumns="False" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None" OnRowCommand="grdSession_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="OTFromDate" HeaderText="OT From Date" />
                                <asp:BoundField DataField="OTToDate" HeaderText="OT To Date" />  <%--CompanyRegistrationID--%>
