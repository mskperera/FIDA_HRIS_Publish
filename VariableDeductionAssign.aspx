<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="VariableDeductionAssign.aspx.cs" Inherits="Smarter_HRIS.VariableDeductionAssign" %>
            ...
            <div class="frames">
                ...
                <div class="frame" id="_page_1">
                            ...
                            <asp:DropDownList ID="drpSessionSearch" runat="server" Width="200"></asp:DropDownList>
                                    ...
                                    <br />
                                    <asp:GridView ID="grdVariableDeduction" DataKeyNames="VariableDeductionID,SessionID,EmployeeID,AllowanceID" Width="100%" runat="server" AutoGenerateColumns="False" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None" OnRowCommand="grdVariableDeduction_RowCommand" OnRowDeleting="grdDeduction_RowDeleting">
