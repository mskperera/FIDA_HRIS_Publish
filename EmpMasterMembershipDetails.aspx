<%@ Page Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="EmpMasterMembershipDetails.aspx.cs" Inherits="Smarter_HRIS.EmpMasterMembershipDetails" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="grid">
                    ...
                    <div class="row">
                        <asp:GridView ID="grdMembership" runat="server" DataKeyNames="EmpMembershipTypeID" Width="50%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdMembership_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="EmpMembershipTypeID" HeaderText="EmpMembershipTypeID" Visible="False" />
