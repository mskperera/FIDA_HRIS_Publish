<%@ Page Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="EmpMasterJobCategoryDetails.aspx.cs" Inherits="Smarter_HRIS.EmpMasterJobCategoryDetails" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="grid">
                    ...
                    <div class="row">
                        <asp:GridView ID="grdCategory" runat="server" DataKeyNames="EmpJobCategoryID" Width="50%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdCategory_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="EmpJobCategoryID" HeaderText="EmpJobCategoryID" Visible="False" />
