<%@ Page Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="EmpMasterMembershipGroupDetails.aspx.cs" Inherits="Smarter_HRIS.EmpMasterMembershipGroupDetails" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="grid">
                    <div class="row">
                        <div class="span2">
                            <label>Membership Group<sup class="fg-red">*</sup></label>
                        </div>
                        <div class="span4">
                    ...
                    <div class="row">
                        <asp:GridView ID="grdMembership" runat="server" DataKeyNames="EmpMembershipGroupID" Width="50%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdMembership_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="EmpMembershipGroupID" HeaderText="EmpMembershipGroupID" Visible="False" />
