<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="ManageHRUserPassword.aspx.cs" Inherits="Smarter_HRIS.ManageHRUserPassword" %>
            ...
            <div class="grid">
                <div class="row">
                    ...
                    <div class="input-control password info-state span4" style="margin-left: 12px;">
                        <input type="password" id="txtNewPassword" name="txtNewPassword" runat="server" placeholder="New Passowrd.." onkeyup="CheckPasswordStrength(this.value)" onkeypress="return isAlphabetKey(event);" />
                        <button class="btn-reveal"></button>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;&nbsp;
                    <div class="input-control password info-state span4" style="margin-left: 12px;">
                        <input type="password" value="" id="txtRepeatPassword" runat="server" placeholder="Repeat New Passowrd.." clientidmode="static" onkeypress="return isAlphabetKey(event);" disabled/>
                        <button class="btn-reveal"></button>
                    </div>
                                </td>
                            </tr>
