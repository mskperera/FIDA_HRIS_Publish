<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ApproveBulkVariableDiductionsAssign.aspx.cs" Inherits="Smarter_HRIS.ApproveBulkVariableDiductionsAssign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container">
                <legend>Cancel Variable Deductions (Excel Uploads)</legend>
