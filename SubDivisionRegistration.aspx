<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="SubDivisionRegistration.aspx.cs" Inherits="Smarter_HRIS.SubDivisionRegistration" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <legend>Sub Division Registraion</legend>
                ...
                <div class="grid">
                    <div class="row">
                        ...
                        <div class="span4">
                            ...
                            <asp:DropDownList ID="drpDivision" Width="200" runat="server"></asp:DropDownList><br />
                    ...
                    <div class="row">
                        <asp:GridView ID="grdSubDiv" runat="server" DataKeyNames="SubDivisionID,CompanyRegistrationID,DivisionID" Width="100%" AutoGenerateColumns="False" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None" OnRowCommand="grdSubDiv_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="SubDivisionID" HeaderText="SubDivisionID" Visible="False" />
                                <asp:BoundField DataField="SubDivisionName" HeaderText="SubDivision Name" />
                                <asp:BoundField DataField="SubDivisionNo" HeaderText="SubDivision No" />
