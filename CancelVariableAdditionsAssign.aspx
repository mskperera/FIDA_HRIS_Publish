<%@ Page Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="CancelVariableAdditionsAssign.aspx.cs" Inherits="Smarter_HRIS.CancelVariableAdditionsAssign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container">
                <legend>Cancel Variable Additions Approval</legend>
