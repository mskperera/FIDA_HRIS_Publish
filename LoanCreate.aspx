<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="LoanCreate.aspx.cs" Inherits="Smarter_HRIS.LoanCreate" %>
                ...
                <div class="grid">
                    <div class="row">
                        <div class="span4">
                            ...
                            <label>Loan ID<sup class="fg-red">*</sup></label>
                            <asp:Label ID="lblLoanID" Font-Bold="true" runat="server" Text=""></asp:Label>
