<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ApproveBulkVariableAdditinsAssign.aspx.cs" Inherits="Smarter_HRIS.ApproveBulkVariableAdditinsAssign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container">
                <legend>Approve Variable Additions (Excel Uploads)</legend>
