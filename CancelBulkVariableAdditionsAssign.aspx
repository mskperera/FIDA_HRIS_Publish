<%@ Page Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="CancelBulkVariableAdditionsAssign.aspx.cs" Inherits="Smarter_HRIS.CancelBulkVariableAdditionsAssign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container">
                <legend>Cancel Variable Addition (Excel Uploads)</legend>
