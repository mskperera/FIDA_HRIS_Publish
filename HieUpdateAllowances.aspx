<%@ Page Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="HieUpdateAllowances.aspx.cs" Inherits="Smarter_HRIS.HieUpdateAllowances" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="grid">
                    ...
                    <div class="row">
                        <asp:GridView ID="grdAllowances" runat="server" DataKeyNames="AllowancesID,PayTypeCategoryID,ZoneID,AllowanceTypeID,CompanyID" Width="100%" AutoGenerateColumns="False" CellPadding="6" CellSpacing="2" ForeColor="#333333" GridLines="None" OnRowCommand="grdAllowances_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="AllowancesID" HeaderText="AllowancesID" Visible="False" />
