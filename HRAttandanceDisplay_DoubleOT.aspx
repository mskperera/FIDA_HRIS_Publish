<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="HRAttandanceDisplay_DoubleOT.aspx.cs" Inherits="Smarter_HRIS.HRAttandanceDisplay_DoubleOT" %>
                ...
                <div class="grid">
                    <div class="row">
                        ...
                        <div class="row">
                            <asp:GridView ID="grdAttendance" runat="server" DataKeyNames="ShiftID,AttendanceID" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="5" CellSpacing="2" Font-Size="Smaller" GridLines="Vertical">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Employee IN">
                                        <ItemTemplate>
                                            <asp:TextBox type="" ID="txtEmployeeIN" runat="server" Width="85" Text='<%# Eval("CheckInTime") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Employee OUT">
                                        <ItemTemplate>
                                            <asp:TextBox type="" ID="txtEmployeeOUT" runat="server" Width="85" Text='<%# Eval("CheckOutTime") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Break Start">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtBreakStart" runat="server" Width="60" Text='<%# Eval("BreakIn") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Break End">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtBreakEnd" runat="server" Width="60" Text='<%# Eval("BreakOut") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="WorkCount" HeaderText="Work Hours" />

                                    <asp:BoundField DataField="IsDayPass" HeaderText="Day Pass" />

                                    <asp:TemplateField HeaderText="CheckOutDate">
                                        <ItemTemplate>
                                            <asp:TextBox type="" ID="txtCheckOutDate"  runat="server" Width="110" Text='<%# Eval("CheckOutDate","{0:MM/dd/yyyy}") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="AttendanceID" HeaderText="AttendanceID" Visible="false" />
                                          <asp:BoundField DataField="IsHoliday" HeaderText="IsHoliday" Visible="true" />
                                          <asp:BoundField DataField="IsLeave" HeaderText="IsLeave" Visible="true" />
                            ...
                            <button class="shortcut primary" type="button" id="bttnApprove" runat="server" onserverclick="bttnApprove_click">
