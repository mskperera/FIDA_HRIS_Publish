<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="FixDeductions.aspx.cs" Inherits="Smarter_HRIS.FixDeductions" %>
    ...
    <div class="container">
        ...
        <div class="grid">
            ...
            <div class="row">
                ...
                <br />
                <asp:GridView ID="grdFixDeductions" DataKeyNames="DeductionsFixAllID,EmployeeID,AllowanceID,IsActive" Width="100%" runat="server" AutoGenerateColumns="False" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None" OnRowCommand="grdFixDeductions_RowCommand" OnRowDeleting="grdFixDeductions_RowCommand">
