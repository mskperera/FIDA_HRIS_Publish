<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="TReviewTraining.aspx.cs" Inherits="Smarter_HRIS.TReviewTraining1" %>
        ...
        <asp:Panel ID="pnlContent" runat="server">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>&nbsp;:&nbsp<asp:DropDownList ID="drpTraining" runat="server" Width="200"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>
