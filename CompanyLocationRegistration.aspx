<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="CompanyLocationRegistration.aspx.cs" Inherits="Smarter_HRIS.CompanyLocationRegistration" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <legend>Company Location Registration</legend>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="grid">
                    <div class="row">
                       <div class="span2">
                        ...
                        <div class="span4">
                               ...
                               <asp:DropDownList ID="drpCompany" Width="200" runat="server" AutoPostBack="True" ></asp:DropDownList>
                    ...
                    <div class="row">
                        <asp:GridView ID="grdCustomerLoc" DataKeyNames="CompanyLocationID,CompanyRegistrationID" Width="100%" runat="server" AutoGenerateColumns="False" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None" OnRowCommand="grdBranch_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                             <asp:BoundField DataField="CustomerLocationID" HeaderText="CustomerLocationID" Visible="False" />
                                       <asp:BoundField DataField="CompanyRegistrationID" HeaderText="Company RegistrationID" Visible="False" />
