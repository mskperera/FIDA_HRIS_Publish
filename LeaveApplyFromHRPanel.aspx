<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveApplyFromHRPanel.aspx.cs" Inherits="Smarter_HRIS.LeaveApplyFromHRPanel" %>
...
<body class ="metro">
    ...
    <div class="row">
        ...
        <label class="fg-black">Remember Me &nbsp;
        <input type="checkbox" />
