<%@ Page Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="EmpMasterNationalityDetails.aspx.cs" Inherits="Smarter_HRIS.EmpMasterNationalityDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <legend>Employee Nationality</legend>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="grid">
                    ...
                    <div class="row">
                        <asp:GridView ID="grdNationality" runat="server" DataKeyNames="EmpNationalityID" Width="50%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdNatio_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="EmpNationalityID" HeaderText="EmpNationalityID" Visible="False" />
