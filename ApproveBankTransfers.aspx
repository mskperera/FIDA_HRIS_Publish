<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ApproveBankTransfers.aspx.cs" Inherits="Smarter_HRIS.ApproveBankTransfers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container">
                <legend>Approve Bank Transfers</legend>
                ...
                <div class="span6">
                    <td>&nbsp;&nbsp;<asp:Label ID="lblEmpID" runat="server" Text="" Visible="false"></asp:Label>
                        ...
                        <br />
                        <div class="span7">
                            <asp:Panel ID="pnlBnk" runat="server"></asp:Panel>
                        </div>
