<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="BankAccountType.aspx.cs" Inherits="Smarter_HRIS.BankAccountType" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="grid">
                    ...
                    <div class="row">
                        <asp:GridView ID="grdAccountType" DataKeyNames="EmpBankAccountTypeID" Width="50%" runat="server" AutoGenerateColumns="False" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None" OnRowCommand="grdAccountType_RowCommand">
