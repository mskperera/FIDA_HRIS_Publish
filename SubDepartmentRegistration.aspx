<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="SubDepartmentRegistration.aspx.cs" Inherits="Smarter_HRIS.SubDepartmentRegistration" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <legend>Sub Department Registration</legend>
                ...
                <div class="grid">
                    <div class="row">
                        ...
                        <div class="span4">
                            ...
                            <asp:DropDownList ID="drpDepartment" Width="200" runat="server"></asp:DropDownList><br />
                        </div>
                        <div class="span2">
                            <label>SubDepartment No</label>
                    ...
                    <div class="row">
                        <asp:GridView ID="grdSubDep" runat="server" DataKeyNames="SubDepartmentID,CompanyRegistrationID,DivisionID,SubDivisionID,DepartmentID" Width="100%" AutoGenerateColumns="False" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None" OnRowCommand="grdSubDep_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="SubDepartmentID" HeaderText="SubDepartmentID" Visible="False" />
                                <asp:BoundField DataField="SubDepartmentName" HeaderText="SubDepartment Name" />
                                <asp:BoundField DataField="SubDepartmentNo" HeaderText="SubDepartment No" />
