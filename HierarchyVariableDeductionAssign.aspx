<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HRMaster.Master" CodeBehind="HierarchyVariableDeductionAssign.aspx.cs" Inherits="Smarter_HRIS.HierarchyVariableDeductionAssign" %>
...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="tab-control" data-role="tab-control" data-effect="fade">
            <ul class="tabs">
                <li class="active"><a href="#_page_1">Variable Deductions Details</a></li>
            ...
            <div class="frames">
                ...
                <div class="frame" id="_page_2">
                    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <legend>Variable Deductions Excel</legend>
                            ...
                            <div class="grid">
                                <div class="row">
                                    <div class="span2">
                                        ...
                                        <label>Variable Deductions<sup class="fg-red">*</sup></label>
                                    </div>
                                    <div class="span3">
                                        <asp:DropDownList ID="drpCompany1"  AutoPostBack="true" OnSelectedIndexChanged="drpCompany1_SelectedIndexChanged" runat="server" Width="200"></asp:DropDownList><br />
                                        <asp:DropDownList ID="drpSession1" runat="server" Width="200"></asp:DropDownList><br />
                                        <asp:DropDownList ID="drpDeduction1" runat="server" Width="200"></asp:DropDownList>
                                    </div>
                                    <div class="span4">
                                    ...
                                    <asp:Panel ID="pnlUpload" runat="server">
                                        <div class="window flat shadow">
                                         ...
                                         <i class="icon-upload-3 bg-cobalt"></i>
                                            ...
                                            <br />
                                            <br />
                                            <asp:GridView ID="grdVariableDeductUpload" DataKeyNames="EmployeeID,SessionID,DeductionID,CompanyID" Width="100%" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="7" CellSpacing="3" GridLines="Vertical">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="DeductionID" HeaderText="AdditionID" Visible="False" />
                                                    <asp:BoundField DataField="DeductionName" HeaderText="Addition Name" />
                ...
                <div class="frame" id="_page_1">
                    <legend>Variable Deductions Assign</legend>
                    ...
                    <div class="grid">
                        ...
                        <div class="row">
                            <div class="span2">
                                ...
                                <label>Deductions Name<sup class="fg-red">*</sup></label>
                                <label>Amount<sup class="fg-red">*</sup></label>
                            </div>
                            <div class="span4">
                                <asp:TextBox ID="txtEmployee" Width="300px" AutoPostBack="true" OnTextChanged="txtEmployee_TextChanged" runat="server"></asp:TextBox>
                                ...
                                <asp:DropDownList ID="drpDeduction" runat="server" Width="200"></asp:DropDownList>
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-md-4">
                                           ...
                                           <div class="col-md-3">
                                                       <div class="form-group-sm row">
                                                <label for="drpDeductionSearch" class="col-md-3 col-form-label">Allowance</label>
                                                <div class="col-md-9">
                                               <asp:DropDownList CssClass="form-control"  ID="drpDeductionSearch" runat="server" Width="200"></asp:DropDownList>
                                                       </div>
                                            </div>
                            ...
                            <div class="row">
                            <asp:GridView ID="grdVariableDeduction" DataKeyNames="VariableDeductionID,SessionID,EmployeeID,AllowanceID" Width="100%" runat="server" AutoGenerateColumns="False" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None" OnRowCommand="grdVariableDeduction_RowCommand">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="VariableDeductionID" HeaderText="VariableDeductionID" Visible="False" />
                                    <asp:BoundField DataField="SessionID" HeaderText="SessionID" Visible="False" />
