<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="LeaveApply_Sinhala.aspx.cs" Inherits="Smarter_HRIS.LeaveApply_Sinhala" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="tab-control" data-role="tab-control" data-effect="fade">
            <ul class="tabs">
                <li class="active"><a href="#_page_1">නිවාඩු අයදුම් කිරීම</a></li>
                <li><a href="#_page_2">නිවාඩු විස්තර</a></li>
                <li><a href="#_page_3">නිවාඩු අනුමත කිරීම්</a></li>
            </ul>
        ...
        <br />--%>
                            ...
                            <legend>නිවාඩු අයදුම් පත</legend>
                                ...
                                <table class="auto-style1">
                                    <tr>
                                        <td class="auto-style2">
                                            <label>
                                                <asp:Label ID="Label2" class="fg-cyan" runat="server" Text="නිවාඩු සඳහා හේතුව "></asp:Label>
                                            </label>
                                        </td>
            ...
            <textarea id="txtreason" runat="server"></textarea>
                                    ...
                                    <tr>
                                        <td class="auto-style2">
                                            <label>
                                                <asp:Label ID="Label1" class="fg-cyan" runat="server" Text="නිවාඩු වර්ගය         " ViewStateMode="Disabled"></asp:Label>
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="auto-style2">
                                            <label>
                                                <asp:Label ID="Label7" class="fg-cyan" runat="server" Text="නිවාඩු කාණ්ඩය         " ViewStateMode="Disabled"></asp:Label>
                                            </label>
                                        </td>
                                        <td class="auto-style4">:</td>
                                        <td class="auto-style3">
                                    ...
                                    <tr>
                                        <td class="auto-style5">
                                            <label>
                                                <asp:Label ID="Label3" class="fg-cyan" runat="server" Text="නිවාඩු අයදුම් කරන දිනය "></asp:Label>
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="auto-style2">
                                            <label>
                                                <asp:Label ID="Label4" class="fg-cyan" runat="server" Text="දිනය සහ වේලාව : සිට "></asp:Label>
                                            </label>
                                        </td>
                                        <td class="auto-style4">:</td>
                                        <td class="auto-style3">
        ...
        &nbsp;<%--<asp:Calendar ID="ClFromDate" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="16px" Width="188px" CellPadding="1" DayNameFormat="Shortest">
                ...
                <asp:Label ID="Label12" class="fg-lightGreen" runat="server" Text="00:00"></asp:Label>
                                    ...
                                    <tr>
                                        <td class="auto-style2">
                                            <label>
                                                <asp:Label ID="Label5" class="fg-cyan" runat="server" Text="දිනය සහ වේලාව : දක්වා "></asp:Label>
                                            </label>
                                        </td>
                                        <td class="auto-style4">:</td>
                                        <td class="auto-style3">
                    ...
                    <WeekendDayStyle BackColor="#CCCCFF" />
                                        ...
                                        <td>
                                            <asp:Button ID="Button2" class="small info" runat="server" OnClick="Button2_Click" Text="පරීක්ෂාකිරීම" /> <asp:Label ID="lblErrorMsg" runat="server"></asp:Label></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style2">
                                            <label>
                                                <asp:Label ID="Label6" class="fg-cyan" runat="server" Text="දින  "></asp:Label>
                                        ...
                                        <td class="auto-style3">
                                            <label>
                                                <asp:Label ID="Label8" class="fg-cyan" runat="server" Text=" පැය  "></asp:Label>
                                                <asp:TextBox ID="txtHours" runat="server" Width="111px"></asp:TextBox>
                                            </label>
                                        </td>
                                        <td class="auto-style9">
                                            <label>
                                                <asp:Label ID="Label9" class="fg-cyan" runat="server" Text=" මිනිත්තු  "></asp:Label>
                                    ...
                                    <tr>
                                        <td class="auto-style2">
                                            <label>
                                                <asp:Label ID="Label10" class="fg-cyan" runat="server" Text="වැඩ ආවරණය කරනු ලබන්නේ "></asp:Label>
                                            </label>
                                        </td>
                                        <td class="auto-style4">:</td>
                                        <td class="auto-style3">
                                        ...
                                        <td class="auto-style9">
                                            <asp:Button ID="Button3" class="small info" runat="server" OnClick="Button3_Click" Text="එකතු කරන්න" Width="115px" />
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                            ...
                            <asp:GridView ID="grdworkcovering" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="7" AutoGenerateColumns="False" CellSpacing="1">
                                <Columns>
                                    <asp:BoundField DataField="NameWithInitials" HeaderText="නම" />
                                    <asp:BoundField DataField="Name" HeaderText="තනතුර" />
                                    <asp:BoundField DataField="MobNo" HeaderText="ජ0ගම දුරකතන අ0කය" />
                                </Columns>
                            ...
                            <br />
                            <br />
                            <asp:Button ID="Button1" Class="large info" runat="server" Text="අයදුම් කරන්න" OnClick="Button1_Click" /><br />
                            <br />
                            <div class="grid">
                                <div class="row">
                                    <div class="span10">
                                    ...
                                    <div class="span10">
                                        <div class="accordion with-marker" data-role="accordion" data-closeany="true">
                                            <div class="accordion-frame">
                                                <a class="heading ribbed-darkCobalt fg-white" href="#"><i class="icon-list"></i>නිවාඩු අනුමත කරනු ලබන නිලධාරින්</a>
                                                <div class="content">
                                                    <asp:GridView ID="grdHierarchy" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="7" CellSpacing="3" ForeColor="#333333" GridLines="None">
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField />
                                                            <asp:BoundField DataField="LevelName" HeaderText="කොට්ඨාශය" />
                                                            <asp:BoundField DataField="NameWithInitials" HeaderText="අධීක්ෂක නම" />
                                                        </Columns>
                            ...
                            <div class="panel" data-role="panel">
                                ...
                                <div class="panel-content">
                                    <div class="grid">
                                        <div class="row">
                                            <div class="span4">
                                                <asp:Label ID="Label15" runat="server" Text="දින සිට"></asp:Label><br />
                                            ...
                                            <div class="span2">
                                                <asp:Label ID="Label14" runat="server" Text="දින දක්වා"></asp:Label><br />
