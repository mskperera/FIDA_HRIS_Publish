<%@ Page Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="CancelVariableDiductionsAssign.aspx.cs" Inherits="Smarter_HRIS.CancelVariableDiductionsAssign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container">
                <legend>Cancel Variable Deductions Approval</legend>
