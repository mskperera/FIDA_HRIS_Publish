<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="CreateHoliday.aspx.cs" Inherits="Smarter_HRIS.CreateHoliday" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <legend>Create Holidays</legend>
        ...
        <div class="grid">
            <div class="row">
            <div class="span3">
                <label>Holiday Name<sup class="fg-red">*</sup></label>
                ...
                <label>Holiday Start Time<sup class="fg-red">*</sup></label>
                ...
                <label>Ending In<sup class="fg-red">*</sup></label>
            ...
            <div class="span3">
                ...
                <label>Holiday End Time<sup class="fg-red">*</sup></label>
                <input type="time" id="txtShiftEnd" runat="server" name="txtShiftEnd"/><br />
                <label>Ending Out<sup class="fg-red">*</sup></label>
                <input type="time" id="txtEndingOut" runat="server" name="txtEndingOut"/><br />
                <label>Is Active Holiday<sup class="fg-red">*</sup></label>
            ...
            <div class="span3">
                ...
                <label>Holiday Type<sup class="fg-red">*</sup></label>
                <asp:DropDownList ID="drpHolidayType" Width="200" runat="server"></asp:DropDownList><br />
                <label>Holiday Category<sup class="fg-red">*</sup></label>
                <asp:DropDownList ID="drpHolidayCat" Width="200" runat="server"></asp:DropDownList><br />
            </div>
            <div class="span3">
                ...
                <label>Is Paid Holiday</label>
                <div class="input-control switch">
                    <label>
                        <input id="chkIsPaid" runat="server" type="checkbox" />
                        <span class="check"></span>
                    </label>
                </div>
                <br />
            ...
            <div class="row">
                <asp:GridView ID="grdHoliday" runat="server" AutoGenerateColumns="False" DataKeyNames="ShiftID,AllowLate,AllowEarly,MustCheckIn,MustcheckOut,AssignBreakID,AssignBreak,ShiftCategoryID,ShiftCategory,DayPass,ShiftTypeID,ShiftType,OTRateID,OTRate,WorkDayCount,HolidayTypeID,HolidayType,HolidayCategoryID,HolidayCategory,IsPaid,Description" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="Vertical" OnRowCommand="grdHoliday_RowCommand" OnRowDeleting="grdHoliday_RowDeleting">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="HolidayTypeID" HeaderText="HolidayTypeID" Visible="False" />
                        <asp:BoundField DataField="HolidayType" HeaderText="HolidayType" Visible="False" />
                        <asp:BoundField DataField="HolidayCategoryID" HeaderText="HolidayCategoryID" Visible="False" />
                        <asp:BoundField DataField="HolidayCategory" HeaderText="HolidayCategory" Visible="False" />
                        <asp:BoundField DataField="IsPaid" HeaderText="IsPaid" Visible="False" />
