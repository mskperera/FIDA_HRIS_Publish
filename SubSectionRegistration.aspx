<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.Master" AutoEventWireup="true" CodeBehind="SubSectionRegistration.aspx.cs" Inherits="Smarter_HRIS.SubSectionRegistration" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <legend>Sub Section Registration</legend>
                ...
                <div class="grid">
                    <div class="row">
                        ...
                        <div class="span3">
                            ...
                            <label>SubSection No</label>
                            <label>SubSection Name</label>
                        </div>
                        <div class="span4">
                            <asp:DropDownList ID="drpSubDepartment" Width="200" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpSubDepartment_SelectedIndexChanged"></asp:DropDownList><br />
                            <asp:DropDownList ID="drpSection" Width="200" runat="server"></asp:DropDownList><br />
                    ...
                    <div class="row">
                        <asp:GridView ID="grdSubSec" runat="server" DataKeyNames="SubSectionID,CompanyRegistrationID,DivisionID,SubDivisionID,DepartmentID,SubDepartmentID,SectionID" AutoGenerateColumns="False" CellPadding="6" CellSpacing="2" ForeColor="#333333" GridLines="None" OnRowCommand="grdSubSec_RowCommand">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="SubSectionID" HeaderText="SubSectionID" Visible="False" />
                                <asp:BoundField DataField="SubSectionName" HeaderText="SubSection Name" />
                                <asp:BoundField DataField="SubSectionNo" HeaderText="SubSection No" />
